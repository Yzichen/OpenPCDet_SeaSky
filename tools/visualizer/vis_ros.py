...
# color_maps = {'car': [0, 1, 1], 'Car': [0, 1, 1], 'truck': [0, 1, 1], 'Vehicle': [0, 1, 1],
#               'construction_vehicle': [0, 1, 1], 'bus': [0, 1, 1], 'trailer': [0, 1, 1],
#               'motorcycle': [0, 1, 0], 'bicycle': [0, 1, 0], 'Cyclist': [0, 1, 0],
#               'Pedestrian': [1, 1, 0], 'pedestrian': [1, 1, 0],
#               'barrier': [1, 1, 1], 'traffic_cone': [1, 1, 1]}

color_maps = {'car': [0, 1, 1], 'truck': [0, 1, 1], 'bus': [0, 1, 1],
              'train': [0, 1, 1], 'motor': [0, 1, 0], 'bicycle': [0, 1, 0], 'pedestrian': [1, 1, 0]}
...
class ROS_MODULE:
    def __init__(self, class_name=['Vehicle', 'Pedestrian', 'Cyclist']):
